...
/**
 * 自定义方块标签，标签内容由数据包提供，文件位于 {@code data/enderechoing/tags/block/} 下，
...
public class TagRegistry {
    ...
    private static TagKey<Block> create(String name) {
        return TagKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(EnderEchoing.MODID, name));
    }
}
